...
### http://www.acajoom.com/license.php
 ...
 function com_install() {
	...
	echo '<br/><br/><br/><br/>';
	echo '<a href="http://www.acajoom.com/content/view/7871/93/" target="_blank">If you have any error during the install process, please refer to our documentation at http://www.acajoom.com/content/view/7871/93/</a>';
	echo '<br/><br/>';
	echo $return;
	return $return;
 }
 ...
 function installBots_11x() {
	...
	$error = '';
	 ...
	 if(!@mkdir(ACA_JPATH_ROOT . '/mambots/acajoom')) {
 ...
 function installModule() {
	...
	//create the module Folder...
			if(!@mkdir (ACA_JPATH_ROOT.DS. $folder, 0777)){
 ...
 function installPlugin() {
	...
	$error = '';
	 ...
	 if (!is_file(ACA_JPATH_ROOT . '/components/com_comprofiler/plugin/user/plug_acajoomcbplugin/acajoom_cb.php')) {
	 	@mkdir(ACA_JPATH_ROOT .'/components/com_comprofiler/plugin/user/plug_acajoomcbplugin');
	 	@chmod(ACA_JPATH_ROOT .'/components/com_comprofiler/plugin/user/plug_acajoomcbplugin', 0777);
	 }
 ...
 function installBots15() {
	...
	$error = '';
	 ...
	 if(!@mkdir(ACA_JPATH_ROOT . '/plugins/acajoom')) {
		 $return .= '<br /> Error adding bot directory.';
	 }
