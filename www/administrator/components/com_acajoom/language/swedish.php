...
define('_ACA_UPDATE_URL_TIPS', compa::encodeutf('Som exempel: http://www.acajoom.com/update/ (inkludera det avslutande slashen)'));
...
define('_ACA_PLEASE_LIC', compa::encodeutf('Kontakta Acajoom support för att uppgradera din licens ( license@acajoom.com ).'));
...
define( '_ACA_UPDATE_CLICK_HERE', compa::encodeutf('Besök <a href="http://www.acajoom.com" target="_blank">www.acajoom.com</a> för att ladda ner den senaste versionen.'));
...
define( '_ACA_MAINTENANCE', compa::encodeutf('Underhåll'));
