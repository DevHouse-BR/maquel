...
define('_ACA_CRON_DESC', compa::encodeutf('<br />Wenn Sie die Cron-Funktion nutzen, können Sie eine automatische Aufgabe für Ihre Joomla Webseite einstellen!<br />' .
		...
		' - Cpanel klicken Sie hier ' .
 		...
 		'<br />Wenn Sie Hilfe bei der Einrichtung brauchen oder Probleme haben, benutzen Sie bitte unser Forum <a href="http://www.acajoom.com" target="_blank">http://www.acajoom.com</a>'));
// sending settings
