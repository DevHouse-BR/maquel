...
define('_ACA_CRON_DESC', compa::encodeutf('<br />Az idõzítõ funkcióval automatikus feladatot lehet beállítani a Joomla webhelyen!<br />Beállításához az alábbi utasítást kell adni az idõzítõ vezérlõpulthoz:<br /><b>' . ACA_JPATH_LIVE . '/index.php?option=com_acajoom&act=cron</b> <br /><br />Ha segítségre van szüksége, keresse fel a <a href="http://www.acajoom.com" target="_blank">http://www.acajoom.com</a> oldal fórumát!'));
// sending settings
...
define('_ACA_UPDATE_URL_TIPS', compa::encodeutf('Például: http://www.acajoom.com/update/ (tartalmazza a lezáró perjelet)'));
...
define('_ACA_PLEASE_LIC', compa::encodeutf('Vegye fel a kapcsolatot az Acajoom támogatóival a licensz frissítése érdekében  ( license@acajoom.com ).'));
...
define( '_ACA_UPDATE_CLICK_HERE', compa::encodeutf('Látogasson el a <a href="http://www.acajoom.com" target="_blank">www.acajoom.com</a> oldalra a legfrissebb verzió letöltéséhez.'));
...
define( '_ACA_MAINTENANCE', compa::encodeutf('Karbantartás'));
