...
define('_ACA_MENU_SUBSCRIBERS', compa::encodeutf('Abonnementen'));
...
define('_ACA_SUB_INFO', compa::encodeutf('Abonnementeninformationen'));
...
define('_ACA_DEFAULT_UNSUBSCRIBE_MESS', compa::encodeutf('Dies ist eine Bestätigungsemail, dass du von der Liste entfernt worden bist. Es tut uns leid, dass du dich entschieden hast, unsere E-Mails nicht weiter zu empfangen. Du kannst dich natürlich jederzeit wieder anmelden.'));

// Acajoom subscribers
define('_ACA_SIGNUP_DATE', compa::encodeutf('Anmeldungsdatum'));
define('_ACA_CONFIRMED', compa::encodeutf('Bestätigung'));
define('_ACA_SUBSCRIB', compa::encodeutf('Aboniert'));
...
define('_ACA_SUSCRIB_LIST', compa::encodeutf('Liste aller Abonnementen'));
define('_ACA_SUSCRIB_LIST_UNIQUE', compa::encodeutf('Angemeldet für: '));
define('_ACA_NO_SUSCRIBERS', compa::encodeutf('Es gibt keine Abonnementen auf dieser Liste'));
define('_ACA_COMFIRM_SUBSCRIPTION', compa::encodeutf('Eine Bestätigungsemail wurde dir zugesand, bitte check deine E-Mails und klick auf den Bestätigungslink.<br />' .
...
define('_ACA_SUBSCRIBER_DELETED', compa::encodeutf('Abonnementen erfolgreich gelöscht'));
...
define('_ACA_HTML_MAILING_DESC', compa::encodeutf('(wenn du dieses änders, musst du speichern und die Seite neu laden, um die Änderungen zu sehen.)'));
...
define('_ACA_INFO_LIST_SENDER_NAME', compa::encodeutf('Trage hier den Namen des Absenders für die Mailings ein. Dieser Name wird sichtbar sein, wenn Abonnementen Nachrichten über diese Liste empfangen.'));
...
define('_ACA_INFO_LIST_UNSUB_MESS', compa::encodeutf('Diese Nachricht wird zum Abonnementen geschickt, wenn er sich von der Liste abgemeldet hat. Jede Nachricht kann hier eingetragen werden.'));
define('_ACA_INFO_LIST_HTML', compa::encodeutf('Wähle dieses wenn du eine HTML-Mail verschicken willst. Abonnementen haben die Möglichkeit sich auszusuchen, ob sie die HTML-Nachricht empfangen wwollen oder nur den reinen Text, wenn sie eine HTML-Liste abonniert haben.'));
...
define('_ACA_NAMEREP', compa::encodeutf('[NAME] = Dies wird durch den Namen des Abonnementen ersetzt, die E-Mail wird also personalisiert, wenn du dieses nutzt.<br />'));
define('_ACA_FIRST_NAME_REP', compa::encodeutf('[FIRSTNAME] = Dies wird durch den VORnamen des Abonnementen ersetzt.<br />'));
...
define('_ACA_SUBSCRIBER_CONFIG', compa::encodeutf('Abonnementen'));
...
define('_ACA_SUBMESSAGE', compa::encodeutf('Abonenmenten Email'));
...
define('_ACA_UPDATE_URL_TIPS', compa::encodeutf('Zum Beispiele: http://www.acajoom.com/update/ (inklusive dem Slash am Ende)'));
...
define('_ACA_UPDATE_MESSAGE_LINK', compa::encodeutf('Klicke hier um upzudaten!'));
define('_ACA_CRON_SETUP', compa::encodeutf('Damit Auto-Responder verschikct werden, musst du einen Cron Task einrichten.'));
define('_ACA_FEATURES', compa::encodeutf('Acajoom, dein Kommunikationspartner!'));
...
define('_ACA_GUIDE_FOUR_ACA_STEP', compa::encodeutf('<p><br />Voila! You are ready to effectively communicate with you visitors and users. This wizard will end as soon as you have entered a second mailing or you can turn it off in the <a href="index2.php?option=com_acajoom&act=configuration" >configuration panel</a>.' .
		...
		'<a target="_blank" href="http://www.acajoom.com/content/blogcategory/29/93/" >documentation</a>. ' .
...
define('_ACA_SUBCRIBERS_VIEW', compa::encodeutf('Zeige Abonnementen'));
...
// since 1.0.6
define('_ACA_NOTIFICATION', compa::encodeutf('Hinweis'));  // shortcut for Email notification
...
define('_ACA_SELECT_SECTION', compa::encodeutf('Select a section'));
...
define('_ACA_PLEASE_LIC', compa::encodeutf('Please contact Acajoom support to upgrade your license ( license@acajoom.com ).'));
...
define( '_ACA_UPDATE_CLICK_HERE', compa::encodeutf('Pleae visit <a href="http://www.acajoom.com" target="_blank">www.acajoom.com</a> to download the newest version.'));
...
define( '_ACA_MAINTENANCE', compa::encodeutf('Maintenance'));
