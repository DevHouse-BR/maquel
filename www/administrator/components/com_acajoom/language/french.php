...
define('_ACA_USE_EMBEDDED_TIPS', compa::encodeutf('Sélectionnez Oui si les images en pièces jointes contiennent des items qui doivent être inclus dans les envois de messages en HTML, ou ne pas utiliser par défaut les tags images qui relient aux images du site.'));
...
define('_ACA_UPDATE_URL_TIPS', compa::encodeutf('Par exemple: http://www.acajoom.com/update/ (inclus le slash fermant)'));
