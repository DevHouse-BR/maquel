...
define('_ACA_MENU_COPY', compa::encodeutf('Kopie&euml;ren'));
...
define('_ACA_MENU_LIST_NEW', compa::encodeutf(' Cre&euml;er een Lijst'));
...
define('_ACA_PUBLISHED', compa::encodeutf('Gepubliseerd'));
...
define('_ACA_LIST_ADDED', compa::encodeutf('Lijst met succes gecre&euml;erd'));
...
define('_ACA_NOT_PUBLISHED', compa::encodeutf('Kan de mailing niet verzenden, de lijst in niet gepubliseerd.'));

//  Lijst informatie box
define('_ACA_INFO_LIST_PUB', compa::encodeutf('Klik op Ja om de lijst te publiseren'));
...
define('_ACA_INFO_LIST_ACA_OWNER', compa::encodeutf('Dit is de ID van de persoon die deze lijst heeft gecre&euml;erd.'));
define('_ACA_INFO_LIST_WARNING', compa::encodeutf('Deze laatste optie is alleen beschikbaar tijdens het cre&euml;ren van de lijst.'));
...
define('_NEW_LIST', compa::encodeutf('Cre&euml;er een nieuwe lijst'));

//titel CRON formulier
define('_ACA_TITLE_FREQ', compa::encodeutf('Bewerk Cron'));
define('_ACA_CRON_SITE_URL', compa::encodeutf('Voer AUB een geldige website url in dat begint met http://'));
...
define('_ACA_NAME_AND_CONFIRM', compa::encodeutf('<b>[CONFIRM]</b> = Dit cre&euml;ert een klikbare link waar de abonnee zijn inschrijving kan bevestigen. Dit is <strong>vereist</strong> om Acajoom goed te laten werken.<br />'
...
define('_ACA_SHOW_GUIDE_TIPS', compa::encodeutf('Geef tijdens het starten de handleiding weer om nieuwe gebruikers te helpen om een nieuwsbrief, een auto-responder te cre&euml;eren en om Acajoom goed in te stellen.'));
...
define('_ACA_SHOW_TIPS_TIPS', compa::encodeutf('Geeft tips weer om gebruikers te helpen om Acajoom effici&euml;nter te gebruiken.'));
...
define('_ACA_UPDATE_URL_TIPS', compa::encodeutf('Voorbeeld: http://www.acajoom.com/update/ (schuine streep is belangrijk)'));
...
define('_ACA_GUIDE_SECOND_ACA_STEP', compa::encodeutf('Cre&euml;er uw eerste lijst!  U kunt nu uw eerste %s opstellen.  Om deze te cre&euml;eren ga naar: '));
...
define('_ACA_GUIDE_SECOND_ACA_STEP_FINAL', compa::encodeutf(' en select uw %s. <br /> Kies dan uw %s in de drop-down lijst.  Cre&euml;er uw eerste mailing door te klikken op Nieuw '));
...
define('_ACA_MAILING_MAX_TIME_TIPS', compa::encodeutf('Defini&euml;er de maximale tijd voor elke set emails verstuurd door de queue. Aanbevolen tussen 30s en 2 minuten.'));
...
define( '_ACA_ERROR_MOVING_UPLOAD', compa::encodeutf('Error met verplaatsen geimporteerd bestand'));
...
define('_ACA_PLEASE_LIC', compa::encodeutf('Contacteer AUB Acajoom support om uw licentie bij te werken ( license@acajoom.com ).'));
...
define( '_ACA_UPDATE_CLICK_HERE', compa::encodeutf('Bezoek AUB <a href="http://www.acajoom.com" target="_blank">www.acajoom.com</a> om de nieuwste versie te downloaden.'));
...
//Archive Configuration
 ...
 define('_ACA_MENU_ARCHIVE_ALL', compa::encodeutf('Archief Alles'));
...
define('_ACA_NB_DAYS_TOOL', compa::encodeutf('Dit is alleen voor de Anders optie! Geef het aantal dagen op tussen elke Archief.'));
...
define('_ACA_TAGS_DATE', compa::encodeutf('[DATE] = Dit zal vervangen worden door de zend datum.'));
...
define( '_ACA_MAINTENANCE', compa::encodeutf('Onderhoud'));
...
define('_ACA_ITEMID_TIPS', compa::encodeutf('Dit ItemId word toegevoegd aan uw Acajoom links.'));
