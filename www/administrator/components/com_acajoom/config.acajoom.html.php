 ...
 class configHTML {
	...
	<table class="acajoomtable" cellspacing="1" width="100%" >
		...
		<tr>
			...
			?>
								<br/>
				<a href="http://www.joobisoft.com" target="_blank">http://www.ijoobi.com</a>
				<br/>
				<br/>
	 ...
	 function showConfigEdit($GLOBALS) {
		...
		if ( ACA_CMSTYPE ) {	// joomla 15
			...
			$lists['mailermethod'] = JHTML::_('select.genericlist', $mailOpt, "config['emailmethod']" , 'class="inputbox" size="1"', 'value', 'text', $GLOBALS[ACA.'emailmethod'] );
			 ...
			 $lists['use_embedded_images'] = JHTML::_('select.booleanlist', "config['use_embedded_images']" , 'class="inputbox"', $GLOBALS[ACA.'use_embedded_images'] );
