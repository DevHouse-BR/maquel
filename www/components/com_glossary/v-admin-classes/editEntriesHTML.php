...
class editEntriesHTML extends cmsapiAdminHTML {
	...
	function edit ($entry, $glossaries) {
		...
		$javascript 	= 'onchange="changeDisplayImage(this.value);"';
		$directory 		= '/images/glossario';
		$imageurl = "/images/glossario/lixo.jpg";
		$imagem = mosAdminMenus::Images( 'imageurl" class="glossary inputbox', $imageurl, $javascript, $directory );
	...
	<script language="javascript">
		function changeDisplayImage(imagem){
			var divImagem = document.getElementById("div_imagem");
			//divImagem.innerHTML = '<img src="/images/glossario/' + imagem + '" />';
			document.write('<img src="/images/glossario/' + imagem + '" />');
		}
	</script>
	<div id="glossary">
