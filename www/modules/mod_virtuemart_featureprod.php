...
if( $db->num_rows() > 0 ) {
	...
	<table class="featureprod-table" border="0" cellpadding="0" cellspacing="4">
	<?php
	$i = 0;
	while($db->next_record() ){
        ...
        ?>
			<tr align="left" class="<?php echo $sectioncolor ?>">
				<td valign="top" width="<?php echo $width ?>%">
					<?php 
					$ps_product->show_snapshot($db->f("product_sku"), $show_price, $show_addtocart, true);
					?><br />
				</td>
			</tr>
		<?php
